...
class VendorProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.product.product_list',compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('vendor.product.create_form',compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.product.list')->with($notification);
    }
    ...
    public function edit($id)
    {
        ...
        return view('vendor.product.edit_form',compact('data'));
    }
