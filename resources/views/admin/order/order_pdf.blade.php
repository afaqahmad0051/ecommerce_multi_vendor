...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            ...
            <h2 style="color: green; font-size: 26px;"><strong>NEST Mart & Grocery</strong></h2>
            </td>
            <td align="right">
                <pre class="font" >
                Nest Mart & Grocery
                shop@nestmart.com
                Mob: (055)4293228
                5171 Utah 53127 United States <br>
                </pre>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                <p class="font">
                    ...
                    Payment Type : {{ strtolower($order->payment_method) }} </span>
                </p>
            </td>
        </tr>
    </table>
    ...
    <table width="100%">
        ...
        <tbody>
            ...
            <tr class="font">
                ...
                <td align="center">{{ isset($item->size)?$item->size:'' }}</td>
                <td align="center">{{ isset($item->color)?$item->color:'' }}</td>
