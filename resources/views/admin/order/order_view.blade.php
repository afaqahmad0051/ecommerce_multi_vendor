                ...
                <div class="card-body">
                    <table class="table" style="font-weight:600;">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($order->status == 'pending')
                                <a href="{{ route('order.status.confirm',$order->id) }}" id="confirm" class="btn btn-block btn-sm btn-success">Confirm Order</a>
                                @elseif($order->status == 'confirm')
                                <a href="{{ route('order.status.process',$order->id) }}" id="process" class="btn btn-block btn-sm btn-success">Processing Order</a>
                                @elseif($order->status == 'processing')
                                <a href="{{ route('order.status.deliver',$order->id) }}" id="deliver" class="btn btn-block btn-sm btn-success">Deliver Order</a>
                                @endif
                            </td>
                        </tr>
                    </table>
