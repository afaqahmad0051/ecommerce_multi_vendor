...
<div class="page-content">
    <div class="row">
        ...
        <div class="col-sm-6">
            @php
                $next = App\Models\BlogCategory::where('id', '>', $category->id)->min('id');
                $previous = App\Models\BlogCategory::where('id', '<', $category->id)->max('id');
            @endphp
            <div class="row">
                <div class="col-md-10">
        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="category" action="{{ route('blog.category.update',$category->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8 form-group">
                                                <input type="text" class="form-control" value="{{ $category->blog_category_name }}" name="blog_category_name"/>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
