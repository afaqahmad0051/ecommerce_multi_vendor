...
<div class="page-content">
    <div class="row">
        ...
        <div class="col-sm-6">
            @php
                $next = Spatie\Permission\Models\Role::where('id', '>', $role->id)->min('id');
                $previous = Spatie\Permission\Models\Role::where('id', '<', $role->id)->max('id');
            @endphp
            <div class="row">
                <div class="col-md-10">
        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="Roles" action="{{ route('permission.role.update',$role->id) }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row mb-3">
