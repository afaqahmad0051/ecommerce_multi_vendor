...
<div class="page-content">
    <div class="row">
        ...
        <div class="col-sm-6">
            @php
                $next = App\Models\Category::where('id', '>', $category->id)->min('id');
                $previous = App\Models\Category::where('id', '<', $category->id)->max('id');
            @endphp
            <div class="row">
                <div class="col-md-10">
        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="category" action="{{ route('category.update',$category->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        @if ($category->category_image != null)
                                            <img class="rounded avatar-lg" id="showImg" src=" {{ asset($category->category_image) }}" style="float: right; heigt:100px; width:100px;">
                                        @else
