...
<div class="page-content">
    <div class="row">
        ...
        <div class="col-md-6">
            <a href="{{ route('brand.create') }}" class="btn btn-success btn-sm" style="float: right;">Create</a>
        </div>
    </div>
    <hr/>
    <div class="card">
                    ...
                    <tbody>
                        @foreach ($brands as $key => $item)                            
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset($item->brand_image) }}" alt="{{ $item->brand_name }}" style="width: 70px; height: 40px;">
                                </td>
                                <td>
                                    @if ($item->status == 1)
