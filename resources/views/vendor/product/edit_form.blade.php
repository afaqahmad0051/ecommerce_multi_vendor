...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            <form id="product_form" action="{{ route('vendor.product.update',$product->id) }}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <div class="card">
        <div class="card-body">
            <div class="form-body mt-4">
                <div class="row">
                    <div class="col-lg-6">
                        <form action="{{ route('vendor.product.update.thumbnail',$product->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="border border-3 p-4 rounded">
                            <div class="row">
                                <table class="table mb-0 table-striped">
                                    ...
                                    <tbody>
                                        <form id="product_form" action="{{ route('vendor.product.update.multiImage') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @foreach ($data['images'] as $key => $image)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('vendor.product.delete.multiImage',$image->id) }}" id="delete" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                </tr>                            
                                            @endforeach
                                        </form>
