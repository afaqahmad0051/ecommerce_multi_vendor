        ...
        <div class="container pt-15 pb-20">
            <div class="row">
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="logo mb-30">
                            <a href="index.html" class="mb-15"><img src="{{asset('user/assets/imgs/theme/logo.svg')}}"
                                    alt="logo" /></a>
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{asset('user/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call
                                    Us:</strong><span>(+91) - 540-025-124553</span></li>
                            <li><img src="{{asset('user/assets/imgs/theme/icons/icon-email-2.svg')}}"
                                    alt="" /><strong>Email:</strong><span>sale@Nest.com</span></li>
                            <li><img src="{{asset('user/assets/imgs/theme/icons/icon-clock.svg')}}"
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        <li><a href="{{ route('vendor.register.apply') }}">Become a Vendor</a></li>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0"><strong class="text-brand">Nest </strong> &copy; {{ date('Y') }}, All rights reserved</p>
            </div>
